...
function PasswordTextField({ className = "", placeholder, required, setDisabled, onChange }) {
		...
		<div className={`relative text-[${primaryGray}] flex flex-col`} >
			{ !hidden ? (
				...
				<svg 
					...
					className="absolute cursor-pointer text-primaryGreen top-8 right-3"
					width="24" 
					height="24" 
					viewBox="0 0 24 24">
			...
			<input 
				className={`active:border-none w-full static active:border-primaryGreen focus:border-primaryGreen text-[#506466] my-3 outline-none h-16 px-3 py-1 font-normal rounded-2xl border-solid border-2 placeholder:decoration-[#A0A9AB] text-base border-[#D1D7D4] ${className}`} 
