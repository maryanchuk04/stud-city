...
export function UserMessages({ fullName, lastDate, lastMessage }) {
	...
	return (
		<Link to={'/chats/asda'} className="w-full mx-auto h-24 flex border-b-[1px] border-gray-300 py-3 pl-1 last:border-0 cursor-pointer hover:bg-customGreen scroll-none">
